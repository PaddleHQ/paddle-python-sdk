...
class TestNotificationsClient:
    ...
    @mark.parametrize(
        "notification_id," "expected_response_status," "expected_response_body," "expected_response_notification_id," "expected_url",
        [
            (
                "nft_01h8441jn5pcwrfhwh78jqt8hk",
                200,
    ...
    def test_replacy_notification_returns_expected_response(
        ...
        assert response == expected_response_notification_id, "The response notification_id doesn't match the expected fixture JSON notification_id"
