...
class TestReportsClient:
    ...
    def test_create_report_validates_allowed_filters(self):
        ...
        assert str(exception_info.value) == "Expected 'filters' to only contain types 'CollectionModeFilter', 'CurrencyCodeFilter', 'TransactionOriginFilter', 'TransactionStatusFilter', 'UpdatedAtFilter' ('AdjustmentActionFilter', 'PriceUpdatedAtFilter' given)"
