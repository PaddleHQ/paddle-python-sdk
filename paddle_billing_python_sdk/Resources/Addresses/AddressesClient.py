...
class AddressesClient:
    ...
    def list(self, operation: ListAddresses = None) -> AddressCollection:
        ...
        response = self.client.get_raw('/addresses', operation.get_parameters())
    ...
    def create(self, customer_id: str, operation: CreateAddress) -> Address:
        response = self.client.post_raw(f"/customers/{customer_id}/addresses", operation.get_parameters())
        parser   = ResponseParser(response)
