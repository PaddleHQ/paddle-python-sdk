...
@dataclass
class SubscriptionHistoryDetailSubscriptionScheduledChangeAdded:
    action: SubscriptionHistoryAction
    scheduled_change: SubscriptionScheduledChange

    @staticmethod
    def from_dict(data: dict[str, Any]) -> SubscriptionHistoryDetailSubscriptionScheduledChangeAdded:
        return SubscriptionHistoryDetailSubscriptionScheduledChangeAdded(
