...
@dataclass
class SubscriptionHistoryDetailSubscriptionItemRemoved:
    ...
    @staticmethod
    def from_dict(data: dict[str, Any]) -> SubscriptionHistoryDetailSubscriptionItemRemoved:
        return SubscriptionHistoryDetailSubscriptionItemRemoved(
