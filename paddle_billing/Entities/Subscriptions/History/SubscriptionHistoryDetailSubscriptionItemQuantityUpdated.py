...
@dataclass
class SubscriptionHistoryDetailSubscriptionItemQuantityUpdated:
    ...
    @staticmethod
    def from_dict(data: dict[str, Any]) -> SubscriptionHistoryDetailSubscriptionItemQuantityUpdated:
        return SubscriptionHistoryDetailSubscriptionItemQuantityUpdated(
